...
#from . import views
from .views import EditProfilePageView, ShowProfilePageView, home, PostsView, PostDetailView, AddPostView, UpdatePostView, DeletePostView, DeleteCommentView, UpdateCommentView
